...
<head>
    ...
    <title>Jaimal Dullat - Full Stack Web Developer</title>

    <!-- Bootstrap Core CSS -->
    <link href="vendors/bootstrap/css/bootstrap.min.css" rel="stylesheet">
    <!-- This is for the animation CSS -->
    <link href="vendors/aos/dist/aos.css" rel="stylesheet">
...
<body class="">
    ...
    <div id="main-wrapper">
        ...
        <section class="section-header" id="section-header">
            ...
            <div class="container">
                <div class="row">
                    <div class="intro col-xs-12 col-sm-10 col-md-8 text-center mx-auto align-self-center " data-aos="fade-down" data-aos-duration="1200">
                        <h1 class="title">I’m <span class="text-success-gradiant font-weight-bold">Jaimal Dullat</span>, Web Designer & Web Developer, Good at <span class="text-success-gradiant typewrite font-weight-bold" data-period="2000" data-type='[ "HTML/HTML5", "CSS/CSS3", "PHP", "Bootstrap4", "JavaScript", "WordPress", "jQuery", "AJAX", "ReactJS", "SQl", "MongoDB" ]'></span></h1>
                        <a class="btn btn-success-gradiant btn-md btn-arrow mg-t-20 btn-mywork" data-toggle="" href="#section-work"><span>Checkout My Work <i class="ti-arrow-right"></i></span></a>
                    </div>
                </div>
            </div>
            <div class="header">
                <div class="container">
                    ...
                    <nav class="navbar navbar-expand-lg h1-nav">
                        ...
                        <div class="collapse navbar-collapse" id="header1">
                            <ul id="top-menu" class="navbar-nav mt-2 mt-lg-0 text-center">
                                <li class="nav-item active"><a class="nav-link" href="#section-header">Home</a></li>
                            ...
                            <ul class="navbar-nav social-icon ml-auto justify-content-center justify-content-md-end">
                                <li class="nav-item"><a class="nav-link" target="_blank" href="https://www.facebook.com/jaimal.dullat.3"><i class="fa fa-facebook"></i></a></li>
                                <li class="nav-item"><a class="nav-link" target="_blank" href="https://www.instagram.com/jaimal_dullat/"><i class="fa fa-instagram"></i></a></li>
                                <li class="nav-item"><a class="nav-link" target="_blank" href="https://www.linkedin.com/in/jaimaldullat/"><i class="fa fa-linkedin-square"></i></a></li>
                                <li class="nav-item"><a class="nav-link" target="_blank" href="mailto:jaimaldullat@gmail.com"><i class="fa fa-envelope" aria-hidden="true"></i></a></li>
                            </ul>
                        </div>
                    </nav>
                    <div class="row">
                ...
                <div class="gradient-line btn-success-gradiant "></div>
            </div>
        </section>
        <!-- ============= -->
        <!-- Section About Me -->
